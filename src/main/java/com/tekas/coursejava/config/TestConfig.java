package com.tekas.coursejava.config;
...
import com.tekas.coursejava.repositories.OrderRepository;
import com.tekas.coursejava.repositories.ProductRepository;
import com.tekas.coursejava.repositories.UserRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        User u1 = new User(null,"Maria Brown", "maria@gmail.com", "988888888", "12345a");
        User u2 = new User(null,"Alex Green", "alex@gmail.com", "977777777", "12345b");


        Order o1 = new Order(null, Instant.parse("2019-06-20T19:53:07Z"), OrderStatus.PAID.getCode(), u1);
        Order o2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.DELIVERED.getCode(), u2);
